...
### 5. 最小給与
給与情報(salaries テーブル)から、従業員番号10001から10100の従業員のうち、最小給与が40,000を下回っている従業員の従業員番号とその最小給与を取得
```sql
...
### 6. 最終勤務日
給与情報(salaries テーブル)から、従業員番号10001から10100の従業員のうち、勤務が終了している従業員の従業員番号と最後の勤務終了日を取得  
なお勤務中の場合、勤務終了日は 9999-01-01 となる
```sql
